...
module.exports = class extends Command {
    ...
    async run(message) {
        ...
        let pingEmbed = new MessageEmbed()
            ...
            .setColor(0)
            .addField(message.language.get('COMMAND_PING_MSG'), `\`\`\`${message.language.get('COMMAND_PING_MS', '?')}\`\`\``, true)
            .addField(message.language.get('COMMAND_PING_WS'), `\`\`\`${message.language.get('COMMAND_PING_MS', '?')}\`\`\``, true)
            .addField(message.language.get('COMMAND_PING_DB'), `\`\`\`${message.language.get('COMMAND_PING_MS', '?')}\`\`\``, true)
            .setTimestamp()
            .setFooter(`Ping`);
        ...
        let xpingEmbed = new MessageEmbed()
            ...
            .addField(message.language.get('COMMAND_PING_WS'), `\`\`\`${message.language.get('COMMAND_PING_MS', clientPingTime)}\`\`\``)
